...
<p>While formal team projects were not a major aspect of the program, collaboration was still present in a meaningful way. Discussion boards served as a forum where classmates posed questions, shared perspectives, and offered feedback on weekly topics. I engaged with my peers regularly, both seeking and providing input, and incorporated both my peers’ and professor’s feedback throughout the program when provided. This exchange of ideas, and willingness to adjust my work based on outside perspective, or when presented additional information, demonstrates my collaborative, inclusive approach to software development.	</p>
