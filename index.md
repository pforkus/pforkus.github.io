...
<p>While formal team projects were not a major aspect of the program, collaboration was still present in a meaningful way. Discussion boards acted as a forum where classmates posed questions, shared perspectives, and offered feedback on weekly topics. I frequented these boards, both seeking and providing input, and incorporated both my peers’ and professor’s feedback throughout the program when provided. This exchange of ideas, and willingness to adjust my work based on outside perspective, or when presented additional information, demonstrates my collaborative, inclusive approach to software development.	</p>
<span class="read-more-target">
<p>Throughout the program, I have improved my communication skills through presentations, weekly discussion posts with classmates, and through correspondence with my professors. As a result, I have become a more effective communicator, speaking confidently in technical terms where the additional precision is necessary, while also having the ability to articulate the same concepts to a more general audience. For example, in my Secure Coding class I developed a security policy presentation for a mock company, covering new coding standards, principles, outlining our defense in depth strategy, encryption policies, and preventative tooling. While the material was technical, the presentation was intended for the entire organization, not just IT, which required me to convey dense technical material more accessibly for a non-technical audience.</p>  
<p>It was this same secure coding course that helped me establish the foundation of my security mindset. Through researching coding standards, principles, and the vulnerabilities that gave rise to them, I began to consider security at every step of implementation, evaluating how a design might be exploited and the severity of these potential exploits. This mindset was further reinforced through coding assignments where we were tasked with identifying, diagnosing, and resolving vulnerabilities in existing code. Understanding how vulnerabilities occur, the patterns they appear in, and the symptoms they produce has made me more effective at identifying them in existing code. It also changed how I write code, with greater attention given to error handling, input validation, edge cases, and the overall implementation design. This capstone allows me to demonstrate this security mindset through its adherence to these practices, but also through additional considerations such as JWT tokens to authenticate users, HTTPS connections to encrypt traffic, password hashing for secure credential storage, and a custom AES-256-GCM encrypted storage solution using the Android Keystore to secure JWT tokens at rest in the Android client.</p>
<p>I first truly grasped the importance of databases and data-rich application during my time in Client/Server Development. I was tasked with developing a CRUD interface to connect a MongoDB instance to a web application I developed for a local animal shelter. I then used the data to populate the webpage with shelter entries in a sortable/filterable table, then i added an interactive pie chart showing breed allocations, and created an interactive map showing the proximity of each shelter animal to the Austin area using entries’ geolocation information. The resulting web app showed me how the right data, well-presented, can transform a simple interface into something genuinely useful. Further into the program, I expanded my database competencies in Mobile Architecture and Programming, where I designed and developed a Room managed SQLite database for an inventory tracking application. I learned the how to design the database and integrate CRUD functionalities into a clean UI, while adhering to MVVM architectures. These experiences provided the foundation on which I built this capstone, which relies heavily on its database to provide an interactive, data-rich experience.</p>
<p>Selecting the right data structure for a given problem is a skill that requires both breadth of knowledge and evaluative judgement. My Data Structure and Algorithm class helped established both, outlining the common data structures, how to implement them, and their strengths and limitations. This knowledge reinforced my software development skills going forward, enabling me to evaluate tradeoffs and select the most appropriate structure for a given context, ultimately producing more efficient and performant software. This evaluative thinking is demonstrated in the capstone, where I implemented a trie to power prefix-based search suggestions provided as the user types a search. This data structure was specifically selected for its efficient character-by-character traversal over alternatives that would have required full string comparisons.</p>
<p>Software engineering and design competencies were developed incrementally across the program, with each course contributing a distinct perspective. Courses like Client/Server Development and Full Stack Development taught me to build interconnected, dependent systems, while Reverse Engineering offered a view of software from the machine's perspective, illuminating how instructions are interpreted at a lower level and deepening my understanding of how vulnerabilities can be introduced and exploited. UI/UX Design and Mobile Architecture and Programming instilled the importance of intuitive, user-centered design, a foundation that was bolstered by a Design course covering color theory, typography, and visual hierarchy. On the development side, Emerging Systems and Architectures pushed me into unfamiliar territory, building and iterating on deep Q-networks, and in doing so reinforced something the program taught consistently: the ability to pick up an unfamiliar technology, work through it methodically, and produce something functional.</p>
<p>In this capstone, I took a single Android application and transformed it into a full-stack system, with each artifact targeting a core area of computer science. For software engineering and design, I built a MEAN stack web application that mirrors the  Android app as a fully functional browser-based interface, using Angular on the frontend and Express on the backend. For databases, I migrated the app's local SQLite database to a remote MongoDB Atlas instance, converting the data model from relational to document-based and connecting it through a shared API. For data structures and algorithms, I improved the search functionality of the Android client by implementing a prefix tree that generates real-time search suggestions as the user types. Together, these artifacts form a distributed system spanning an MVC web client, an MVVM Android client, and a shared cloud backend, demonstrating my abilities across full-stack, mobile, and cloud development domains.</p>
</span>
</div>
